...
public enum MteStatus
{
  ...
  public static MteStatus valueOf(int i) { return map.get(i); }
  private static final Map<Integer, MteStatus> map =
    new HashMap<>();
  static
  {
    for (MteStatus e : MteStatus.values())
    {
